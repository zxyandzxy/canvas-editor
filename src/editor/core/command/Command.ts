...
export class Command {
  ...
  // 协同用户选区
  public setUserRange: CommandAdapt['setUserRange']
  // 协同用户取消选区
  public setUserUnRange: CommandAdapt['setUserUnRange']

  // 设置旧选区
  // public setLastRange: CommandAdapt['setLastRange']

  // keydown handle
  public executeKeydown: CommandAdapt['keydwnHandle']

  // 选区内容变化
  public executeContentChange: CommandAdapt['contentChangeHandle']

  // 选区样式变化
  public executeRangeStyle: CommandAdapt['rangeStyleChange']

  // 获取旧选区
  public getLastRange: CommandAdapt['getLastRange']

  // 设置页面缩放至指定值
  public executePageScale: CommandAdapt['executePageScale']

  // 关闭 websocket
  public closeWebSocket: CommandAdapt['closeWebSocket']
  ...
  constructor(adapt: CommandAdapt) {
    ...
    // 设置旧选区
    // this.setLastRange = adapt.setLastRange.bind(adapt)
