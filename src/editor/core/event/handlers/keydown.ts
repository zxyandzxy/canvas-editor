import Editor, { EditorZone } from '../../..'
import { ZERO } from '../../../dataset/constant/Common'
import { ElementType } from '../../../dataset/enum/Element'
import { KeyMap } from '../../../dataset/enum/KeyMap'
import { MoveDirection } from '../../../dataset/enum/Observer'
import { IElement, IElementPosition } from '../../../interface/Element'
import { IKeydown } from '../../../interface/Websocket'
import { formatElementContext } from '../../../utils/element'
import { isMod } from '../../../utils/hotkey'
import { CanvasEvent } from '../CanvasEvent'

export function keydown(evt: KeyboardEvent, host: CanvasEvent, editor: Editor) {
...
interface IBroadcastKeydown {
  startIndex: number
  endIndex: number
  type: string
}

function broadcastKeydown(
  host: CanvasEvent,
  { startIndex, endIndex, type }: IBroadcastKeydown,
  editor: Editor
) {
  if (host.isComposing) return
  const draw = host.getDraw()
  ...
  const { data } = draw.getValue()
  ydoc.keydownHandle(<IKeydown>{
    type,
    startIndex,
    endIndex,
    data
